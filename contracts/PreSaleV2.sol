...
contract PresaleV2 is Ownable, ReentrancyGuard {
    ...
    /// @notice Token price for presale. On softcap it's firstTokenPrice and it will be updated to secondTokenPrice
